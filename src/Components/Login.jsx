...
import LoginBackground from "../Assets/Login/bglogin-min.webp";
  ...
  return (
    <>
      <img
        ...
        alt="bg"
      />
      <div className="bg-black z-30 absolute w-full h-full opacity-30" />
              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-6" onSubmit={formik.handleSubmit}>
                  ...
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                    Üye değil misiniz ? <a href="/register" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Hemen üye ol</a>
                  </p>
                </form>
              </div>
            </div>
